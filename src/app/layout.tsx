...
export const metadata: Metadata = {
  title: "Nishi Beauty Parlour | Bridal Makeup & Beauty Services",  description: "Professional beauty parlour offering bridal makeup, facials, hair styling, waxing, threading, and more in Uttar Pradesh. 4.2★ rated. Book now!",  keywords: "beauty parlour, bridal makeup, facial, hair styling, waxing, threading, beauty salon near me, Uttar Pradesh",  metadataBase: new URL("https://nishibeautyparlour.com"),
  alternates: {
    canonical: "https://nishibeautyparlour.com"
  },
  openGraph: {
    title: "Nishi Beauty Parlour - Your Local Beauty Expert",    description: "Transform your beauty with professional services at Nishi Beauty Parlour. Bridal makeup, facials, hair styling, and more.",    url: "https://nishibeautyparlour.com",    siteName: "Nishi Beauty Parlour",    type: "website",    images: [
      {
        url: "http://img.b2bpic.net/free-photo/visagiste-making-facial-makeup-brunette-model-studio_23-2148113100.jpg",        alt: "Nishi Beauty Parlour - Professional Beauty Services"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Nishi Beauty Parlour | Bridal Makeup & Beauty Services",    description: "Professional beauty parlour with expert team. Book your appointment today!",    images: ["http://img.b2bpic.net/free-photo/visagiste-making-facial-makeup-brunette-model-studio_23-2148113100.jpg"]
  },
  robots: {
    index: true,
    follow: true
